...
plot(group_net1, vertex.color=c("green","pink","red","blue","yellow")[(get.vertex.attribute(group_net1, "group"))])
ggnet2(group_net1, mode = "fruchtermanreingold", node.size = 4, color= "group")
install.packages("GGally")
library(GGally)
ggnet(group_net1, mode = "fruchtermanreingold",node.color = "group", segment.color = "grey50")
...
library(plotly)
#visualization
plotly(data1.1, x = ~Gender, y = ~Marital.Status, z = ~test1.1, type = "scatter3d", 
...
<<<<<<< HEAD
“Lethal Connections: The Determinants of Network Connections in the Provisional Irish Republican Army, 1970–1998.” Taylor and Francis Online, www.tandfonline.com/doi/full/10.1080/03050629.2013.863190.

https://sites.google.com/site/ucinetsoftware/datasets/covert-networks/provisionalirishrepublicanarmy (dataset)
=======

>>>>>>> 1ab99d05afd136b5bd3fbc75e0d28be1761741c5
