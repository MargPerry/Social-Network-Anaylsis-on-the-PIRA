...
* What contribute to the formation of friendship grouos? And has it changed overtime? 
...
plot(net_3, vertex.col=c("pink","blue")[(get.vertex.attribute(net_3, "Marital.Status"))])
...
plot(net_6, vertex.col=c("pink","blue")[(get.vertex.attribute(net_6, "Marital.Status"))])
```
